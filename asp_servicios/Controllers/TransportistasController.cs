...
namespace asp_servicios.Controllers
{
    ...
    {
        private ITransportistasAplicacion? iAplicacion = null;
        private TokenController? tokenController = null;

        public TransportistasController(ITransportistasAplicacion? iAplicacion,
        ...
        public string Buscar()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Transportistas>(
